...
def bullish_m5_setup() -> tuple[Candle, ...]:
    ...
    for index in range(45):
        open_ = price
        close = price + (0.24 if index % 3 else -0.10)
    ...
    pullback = [
        (2408.40, 2408.90, 2406.90, 2407.00),
        (2407.00, 2407.45, 2405.90, 2406.20),
        (2406.20, 2406.75, 2405.20, 2405.70),
        (2405.70, 2406.25, 2404.48, 2405.10),
        (2405.10, 2405.85, 2404.95, 2405.45),
        (2405.45, 2406.05, 2404.50, 2405.00),
        (2405.00, 2405.65, 2404.92, 2405.30),
        (2405.30, 2405.90, 2404.49, 2405.05),
        (2405.05, 2405.70, 2404.94, 2405.35),
        (2405.35, 2405.95, 2404.52, 2405.08),
        (2405.08, 2405.72, 2404.90, 2405.32),
        (2405.32, 2405.88, 2404.54, 2405.02),
    ]
    ...
    candles.extend(
        [
            candle(57, 2405.02, 2405.25, 2403.95, 2404.85),
            candle(58, 2404.85, 2405.80, 2404.75, 2405.45),
            candle(59, 2405.45, 2407.65, 2405.30, 2407.20),
        ]
    )
    return tuple(candles)
